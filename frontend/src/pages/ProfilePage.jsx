   ...
   >
      ...
      <span className="relative font-mono text-xs font-bold tracking-[0.2em] text-cyan-400 group-hover:text-white uppercase">
        Edit Profile
               ...
               <button className="relative group overflow-hidden rounded-xl bg-[#0a1628] border border-white/10 p-4 text-center hover:border-white/30 transition-all duration-300">
